...
function Ie(e, t) {
	let { body: n } = R, r = n.x - 6, i = t ? z.right + 6 : n.x + n.width + 6, a = n.y - 13, o = R.display.y + R.display.height, s = e === "focus" ? t ? Math.min(o + 22, z.top) : o + 40 : e === "mid" ? Math.round((z.top + z.bottom) / 2 + 62) : Math.min(z.bottom + 12, R.canvasHeight);
	return {
		x: r,
		y: a,
		width: i - r,
