...
function Be(e, t) {
	let { body: n } = P, r = n.x - 6, i = t ? F.right + 6 : n.x + n.width + 6, a = n.y - 13, o = P.display.y + P.display.height, s = e === "focus" ? t ? Math.min(o + 22, F.top) : o + 82 : e === "mid" ? Math.round((F.top + F.bottom) / 2 + 62) : Math.min(F.bottom + 12, P.canvasHeight);
	return {
		x: r,
		y: a,
		width: i - r,
